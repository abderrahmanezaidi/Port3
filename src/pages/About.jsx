...
import { experiences, skills, Academic } from "../constants";
    ...
    <div className='mt-16 flex flex-wrap gap-12 justify-center'>
            ...
            <div className='block-container w-72 p-4 bg-white shadow-lg rounded-xl transition-transform duration-300 transform hover:scale-105' key={item.name}>
                <div className='btn-back rounded-xl'>
                    <div className='btn-front rounded-xl flex justify-center items-center'>
                        <img
                            src={item.imageUrl} // Use the image URL from the Academic array
                            alt={item.name} // Alt text for accessibility
                            className='w-24 h-24 object-contain'
                            onError={(e) => {
                                e.target.onerror = null; // Prevent fallback loop
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>
          I have successfully undertaken multiple projects that align with my internships and academic coursework. These projects encompassed a diverse range of topics, focusing on both networking and development.          </p>
        </div>
